...
class CobblerXMLRPCInterface:
    ...
    def find_mgmtclass(self,criteria={},expand=False,token=None,**rest):
        return self.find_mgmtclass("mgmtclass",criteria,expand=expand)
    ...
    def new_item(self,what,token,is_subobject=False):
        ...
        "what" specifies the type of object: 
            distro, profile, system, repo, image, or mgmtclass
        """      
        ...
        if what == "distro":
            ...
            d = item_mgmtclass.Mgmtclass(self.api._config)
        else:
    ...
    def get_mgmtclasses_since(self,mtime):
        """
        See documentation for get_mgmtclasses_since
        """
   ...
   ######
    ...
    def check_access_no_fail(self,token,resource,arg1=None,arg2=None):
        ...
        need_remap = False
        for x in [ "distro", "profile", "system", "repo", "image", "mgmtclass" ]:
